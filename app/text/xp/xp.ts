export const experiences = [
  ...
  },
  {
    ...
    description: {
      en: 'In this position, my main responsibilities were to create scalable microservices using SOLID principles and Clean Code to achieve the best performance. I worked with payment methods, integration with card flags, digital wallets, and bank slips. Additionally, I performed the migration of legacy services.',
      pt: 'Nesta posição, minhas principais responsabilidades foram criar microsserviços escaláveis utilizando os princípios SOLID e Clean Code para alcançar o melhor desempenho. Trabalhei com métodos de pagamento, integração com bandeiras de cartão, carteiras digitais e boletos bancários. Além disso, realizei a migração de serviços legados.'
    },
    skills: ['Node.js', 'Typescript', 'REST', 'React.js', 'AWS', 'Docker', 'Kafka'],
  },
  {
    title: 'Back-end Developer',
    company: 'PUCRS - Pontifícia Universidade Católica do Rio Grande do Sul',
    date: 'Sep 2018 – Aug 2019',
    description: {
      en: `My responsibilities in this position were primarily the maintenance of all university systems and databases. I worked extensively with Java 8 for developing new functionalities and maintaining legacy systems. I utilized the Oracle database to manage and optimize data storage. Additionally, I created new microservices and functionalities using Node.js, integrating them with existing systems to enhance efficiency and scalability.`,
      pt: 'Minhas responsabilidades nesta posição foram, principalmente, a manutenção de todos os sistemas e bancos de dados da universidade. Trabalhei extensivamente com Java 8 para desenvolver novas funcionalidades e manter sistemas legados. Utilizei o banco de dados Oracle para gerenciar e otimizar o armazenamento de dados. Além disso, criei novos microsserviços e funcionalidades utilizando Node.js, integrando-os com sistemas existentes para aumentar a eficiência e a escalabilidade.'
    },
    skills: ['Java', 'Node.js', 'Javascript', 'REST', 'AWS', 'PL/SQL', 'Docker'],
  },
  {
    title: 'Developer',
    company: 'Foxter Cia. Imobiliária',
